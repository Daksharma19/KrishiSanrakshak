...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Check if the phone number and password match in the database
    ...
    if ($result->num_rows > 0) {
        ...
        echo "Error: Invalid phone number or password!";
    }
...
<head>
    ...
    <title>Sign In - Farm Optimizer</title>
    <style>
        /* General Styles */
        body {
  ...
  <script src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <section class="signin">
        ...
        <form action="signin.php" method="POST">
            ...
            <label for="signinPassword" id="signinPasswordLabel">Password:</label>
            <input type="password" id="signinPassword" name="password" required>

            <button type="submit" id="signinButton">Sign In</button>
        </form>
        <p id="signupPrompt">Don't have an account? <a href="signup.php" id="signupLink">Sign Up</a></p>
    </section>
